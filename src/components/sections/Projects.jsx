      ...
      <RevealOnScroll>
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* 2. Corporate Form */}
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-800/50 hover:shadow-[0_2px_8px_rgba(30,58,138,0.4)] transition">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {["JavaScript", "REST API", "Vanilla JavaScript"].map(
                  (tech, key) => (
                    <span
                      key={key}
                      className="bg-blue-900/30 text-blue-300 py-1 px-3 rounded-full text-sm hover:bg-blue-900/50 hover:shadow-[0_2px_8px_rgba(30,58,138,0.4)] transition-all"
                    >
                      {tech}
                    </span>
                  ),
              ...
              <div className="flex justify-between items-center mt-auto">
                <a
                  ...
                  className="text-blue-300 hover:text-blue-200 transition-colors my-4"
                >
                  {texts[language].view}
                </a>
              </div>
            ...
            <div
              ...
              hover:-translate-y-1 hover:border-blue-800/50
                ...
                {["Next.js", "TypeScript", "Stripe", "PostgreSQL"].map(
                  (tech) => (
                    <span
                      key={tech}
                      className="
                      bg-blue-900/30 text-blue-300 py-1 px-3 
                      rounded-full text-sm
                      transition
                      hover:bg-blue-900/50 hover:-translate-y-0.5
                      hover:shadow-[0_2px_8px_rgba(30,58,138,0.4)]
                    "
                    >
                      {tech}
                    </span>
